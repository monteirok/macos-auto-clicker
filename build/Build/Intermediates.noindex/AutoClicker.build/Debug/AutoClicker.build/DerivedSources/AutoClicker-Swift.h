...
#ifndef AUTOCLICKER_SWIFT_H
#define AUTOCLICKER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AutoClicker",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSCoder;
SWIFT_CLASS("_TtC11AutoClicker18OverlayContentView")
...
SWIFT_CLASS("_TtC11AutoClicker13OverlayPicker")
@interface OverlayPicker : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSEvent;
SWIFT_CLASS("_TtC11AutoClicker13OverlayWindow")
